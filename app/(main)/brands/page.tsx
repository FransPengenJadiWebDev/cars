...
const brands = () => {
    ...
    return (
        <div className='px-4 lg:px-7 w-full my-20 lg:my-0 lg:mt-30 lg:mb-40'>
            <div className='mb-8 flex flex-row'>
                <div className='flex flex-col flex-1 gap-2'>
                    <h2 className='font-bold text-orange-500 uppercase text-xs lg:text-sm tracking-[0.2rem]'>Exclusive Collections</h2>
                    <h1 className='text-white font-bold text-3xl lg:text-5xl leading-tight'>All Brands</h1>
                    <p className='leading-relaxed text-sm lg:text-lg text-gray-400'>Explore the world's most prestigious automotive engineering in one place.</p>
                </div>
                <div className='flex-1 flex flex-col justify-end items-end'>
                    <span className="uppercase text-xs lg:text-sm text-neutral-500 group-hover:text-orange-500 transition-colors">{BRANDS_DATA.length} Brands</span>
                </div>
            </div>
