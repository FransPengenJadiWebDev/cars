...
const contact = () => {
  return (
    <div className='flex lg:flex-row flex-col gap-8 px-7 py-20 lg:py-37'>
      ...
      <div className='flex-1 bg-black rounded-xl pl-7 py-7 lg:pl-12 lg:py-12 flex flex-col gap-6 lg:gap-10'>
        <div className='flex flex-row gap-6 items-start text-xs lg:text-sm'>
